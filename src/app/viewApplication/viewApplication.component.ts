...
/**
 * This class represents the lazy loaded ViewApplicationComponent.
 */
@Component({
  moduleId: module.id,
  selector: 'app-sd-view-application',
  templateUrl: 'viewApplication.component.html',
  styleUrls: ['../editApplication/editApplication.component.scss'],
...
export class ViewApplicationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getDataList('../../assets/data/dataTableViewApplicationForms.json');
  }
